SERVER_COMMAND="node /Users/marcpla/Documents/Feina/Projectes/mcp/ibm-rally-context/index.js"
...
npx @modelcontextprotocol/inspector $SERVER_COMMAND -e RALLY_INSTANCE=$(grep RALLY_INSTANCE .env | cut -d= -f2) -e RALLY_APIKEY=$(grep RALLY_APIKEY .env | cut -d= -f2) -e RALLY_PROJECT_NAME=$(grep RALLY_PROJECT_NAME .env | cut -d= -f2) > "$temp_file" 2>&1 &
